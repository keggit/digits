      ...
      <div className="digits-landing-background">
        <Grid id='landing-page' container centered stackable columns={3}>
          ...
          <Grid.Column textAlign='center'>\
            ...
            <Header as="h3" inverted>This address book enables any number of users to register and save their businesso contacts. You can only see the contacts you have created.</Header>
          </Grid.Column>
